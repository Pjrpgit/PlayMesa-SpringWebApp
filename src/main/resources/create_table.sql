...
--
-- Host: localhost    Database: play_mesa
-- ------------------------------------------------------
...
CREATE TABLE `editorial` (
  `editorial_id` int(255) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(512) NOT NULL,
  `descripcion` varchar(1024) DEFAULT NULL,
...
CREATE TABLE `habilidad` (
  `habilidad_id` int(255) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(512) NOT NULL,
  `descripcion` varchar(1024) DEFAULT NULL,
  `imagen` varchar(512) DEFAULT NULL,
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `juego` (
  `juego_id` int(255) NOT NULL AUTO_INCREMENT,
  ...
  KEY `juegocategoriafk_idx` (`categoria_id`),
  KEY `juegoeditorialfk_idx` (`editorial_id`),
  CONSTRAINT `juegocategoriafk` FOREIGN KEY (`categoria_id`) REFERENCES `categoria` (`categoria_id`),
  CONSTRAINT `juegoeditorialfk` FOREIGN KEY (`editorial_id`) REFERENCES `editorial` (`editorial_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `juego_habilidad` (
  ...
  `relacion_id` int(255) NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(1024) DEFAULT NULL,
  PRIMARY KEY (`relacion_id`),
  KEY `relacionjuegofk_idx` (`habilidad_id`),
  KEY `relacionjuegofk_idx1` (`juego_id`),
  CONSTRAINT `relacionhabilidadfk` FOREIGN KEY (`habilidad_id`) REFERENCES `habilidad` (`habilidad_id`),
  CONSTRAINT `relacionjuegofk` FOREIGN KEY (`juego_id`) REFERENCES `juego` (`juego_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-03-16 12:33:26
